...
<script src="../js/jquery.validate.min.js"></script>
 ...
 <body>
  ...
  <ul class="nav nav-tabs">
    <li class="nav-item">
      <a class="nav-link" href="#">Rong Chen</a>
      </li>
      <li class="nav-item">
        ...
        <a class="nav-link" href="VS2.php">VStar</a>
            ...
            <li class="nav-item">
           <a class="nav-link" href="emekaedogo2.php" tabindex="-1">Emeka Dogo</a>
          </li>
     </ul>
  ...
  <?php 
   ...
   JOIN transactions ON item.id = transactions.itemId WHERE item.companyId = 1";
...
<tr>
     ...
     <td><?='N'.$TP;?></td>
     <td><?=$DC;?></td>
     <td><a class="btn btn-primary" id="my" href="payform.php?pay=<?php echo $row['tid']?>">Payments</td>
