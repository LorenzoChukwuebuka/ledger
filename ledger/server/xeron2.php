 ...
 <body>
  ...
  <ul class="nav nav-tabs">
    <li class="nav-item">
      ...
      <li class="nav-item">
         <a class="nav-link" href="#">Xeron</a>
      </li>
         <li class="nav-item">
        <a class="nav-link" href="VS2.php">VStar</a>
          </li>
            <li class="nav-item">
           <a class="nav-link" href="emekadogo2.php" tabindex="-1">Emeka Dogo</a>
          </li>
     </ul>
  ...
  <?php 
   ...
   JOIN transactions ON item.id = transactions.itemId WHERE item.companyId = 2";
